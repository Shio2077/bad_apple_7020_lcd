...
#
# Generated by export_simulation on Mon Nov 18 22:17:06 +0800 2024
#
################################################################################
...
'-reset_run' switch to the './zynq_7.sh' script.
...
./zynq_7.sh -noclean_files

For more information on the script, please type './zynq_7.sh -help'.
